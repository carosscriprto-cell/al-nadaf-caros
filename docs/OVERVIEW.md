...
| **White-label** | Per-tenant colors (injected as CSS vars on `<body>`), logo/favicon/OG, SEO, contact/social/hours/map, home section order+visibility (`sections`), optional pages/buttons (`pages`), editable bilingual copy (`content`) |
