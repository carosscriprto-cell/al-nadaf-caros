  ...
  en: {
    ...
    st: {
      ...
      f: {
        ...
        logo_url: 'Logo URL', logo_dark_url: 'Logo (dark / for light background)', favicon_url: 'Favicon URL', hero_image_url: 'Hero background', og_image_url: 'Social share image (OG) URL',
        seo_title_en: 'SEO title (EN)', seo_title_ar: 'SEO title (AR)', seo_desc_en: 'SEO description (EN)', seo_desc_ar: 'SEO description (AR)',
        footer_tagline_en: 'Footer tagline (EN)', footer_tagline_ar: 'Footer tagline (AR)',
  ...
  ar: {
    ...
    st: {
      ...
      f: {
        ...
        logo_url: 'رابط الشعار', logo_dark_url: 'الشعار (داكن / لخلفية فاتحة)', favicon_url: 'رابط الأيقونة', hero_image_url: 'خلفية الواجهة', og_image_url: 'رابط صورة المشاركة (OG)',
