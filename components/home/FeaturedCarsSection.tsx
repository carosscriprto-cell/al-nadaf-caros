...
const getCarsByTab = (tab: FeaturedTab) => {
  switch (tab) {
    case 'featured':
    ...
    case 'rent':
      return cars
        .filter(
          (c) =>
            c.listingType === 'rent' || c.listingType === 'both'
        )
        .slice(0, 6);
    case 'sale':
      return cars
        .filter(
          (c) =>
            c.listingType === 'sale' || c.listingType === 'both'
        )
        .slice(0, 6);
    case 'new':
    ...
    <section className="relative overflow-hidden bg-background py-20">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-2 flex items-center justify-between">
            {/* Tabs (Chip style like your filters) */}
